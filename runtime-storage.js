(() => {
  ...
  const RECORD_COLLECTIONS = Object.freeze(["bills", "travelers", "todos", "tickets", "itinerary", "settlements"]);
  ...
  function normalizeSnapshot(raw) {
    ...
    return {
      ...
      settlements: Array.isArray(raw.settlements) ? deepClone(raw.settlements) : [],
